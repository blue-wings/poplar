package com.poplar.server.appExecutor.executor;

import com.poplar.server.appExecutor.web.ControllerProxy;
import com.poplar.server.appExecutor.web.Dispatcher;
import com.poplar.server.httpObj.*;
import com.poplar.server.httpObj.app.AppRequest;
import com.poplar.server.httpObj.app.AppResponse;
import com.poplar.server.httpObj.parameterDisposer.ParameterDisposer;
...
public class AppExecutor {
    ...
    public static Response execute(Request request) {
        ...
        ControllerProxy controllerProxy = Dispatcher.getMapping(url);
